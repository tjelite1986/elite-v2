...
const TABS = [
  ...
  { label: "Videos", href: "/posts/videos" },
...
function activeHref(pathname: string): string {
  ...
  if (pathname.startsWith("/posts/videos")) return "/posts/videos";
...
export default function PostsTabs() {
  ...
  return (
    <div className="fixed left-1/2 top-3 z-40 max-w-[96vw] -translate-x-1/2 overflow-x-auto">
