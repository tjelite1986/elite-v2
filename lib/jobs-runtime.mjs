...
export const JOBS = [
  ...
  },
  {
    ...
    description:
      "Convert library videos a browser cannot play (DVD rips, HEVC, AC-3, .mkv/.avi) to H.264/AAC MP4, replacing the source. Works the queue within a time budget, so a big backlog is spread over several runs.",
    defaultIntervalSeconds: 3600,
    run: {
      kind: "http",
