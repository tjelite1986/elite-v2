...
// Proxy to the grabbit grabber: resolve a single video URL (admin only). Lived
// under /api/shorts while the shorts library did; the music grabber is the only
// caller left, so it moved out with the section rather than going with it.
