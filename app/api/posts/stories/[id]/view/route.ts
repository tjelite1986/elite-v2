...
// Mark a story as seen by the viewer. Gated the same as the media route (author
// or follower, plus the 18+ PIN for the adult account's stories) so view-count
// analytics can't be polled/polluted by a viewer who couldn't see the story.
